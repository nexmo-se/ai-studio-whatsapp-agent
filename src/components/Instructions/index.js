...
export default function Instructions({userId, setUserId}) {
    ...
    return (
        ...
        {open &&
          <div id="instruction">
            <h4>Please paste below URLs in your AI Studio <a target="_blank" rel="noreferrer" href="https://studio.docs.ai.vonage.com/whatsapp/nodes/actions/live-agent-routing">Whatsapp Live Agent Routing Node</a>.</h4>
